...
namespace App\Filament\Clusters\FleetData\Resources\VehicleGroups;

use App\Filament\Clusters\FleetData\FleetDataCluster;
use App\Filament\Clusters\FleetData\Resources\VehicleGroups\Pages\ManageVehicleGroups;
...
class VehicleGroupResource extends Resource
{
    ...
    {
        return [
            'index' => ManageVehicleGroups::route('/'),
        ];
    }
}
