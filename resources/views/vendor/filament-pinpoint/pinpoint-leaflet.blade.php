...
<x-dynamic-component :component="$getFieldWrapperView()" :field="$field">
    ...
    <style>
        ...
        .dark .pinpoint-location-btn   { color: #e5e7eb; background-color: #242427; border-color: #4b5563; }
        .dark .pinpoint-location-btn:hover { background-color: #242427; border-color: #B16F09; color: #f9fafb; }
    </style>
</x-dynamic-component>
